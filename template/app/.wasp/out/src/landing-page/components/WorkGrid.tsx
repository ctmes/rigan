...
export default function WorkGrid({ caseStudies }: { caseStudies: CaseStudy[] }) {
  return (
    <div id="work" className="mx-auto my-32 max-w-7xl px-6 lg:px-8">
      <SectionTitle
        title="Selected work"
        description="A sample of what we've built. Every engagement is confidential — these are shared with permission."
      />
