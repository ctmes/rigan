...
export default function SecurityHighlight() {
  return (
    <HighlightedFeature
      name="Built to be trusted"
      description="Security and stability aren't afterthoughts at Rigan Studios. Every system we build is designed with threat modeling, least-privilege access, and long-term maintainability in mind — so your automation keeps running years after we ship it."
      highlightedComponent={<SecurityDiagram />}
...
const SecurityDiagram = () => {
  return (
    <div className="bg-background border-border w-full max-w-md overflow-hidden rounded-xl border font-mono text-sm shadow-xl">
