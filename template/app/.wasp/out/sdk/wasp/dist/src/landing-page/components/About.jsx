...
export default function About() {
    return (<div id="about" className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
      <SectionTitle title="The team" description="Small by design. Every engagement involves senior engineers who care deeply about the work."/>
      <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:max-w-4xl">
        {team.map((member) => (<div key={member.name + member.title} className="border-border bg-card flex flex-col items-center rounded-2xl border p-8 text-center shadow-sm">
