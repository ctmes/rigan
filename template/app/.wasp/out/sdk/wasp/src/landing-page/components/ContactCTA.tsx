...
export default function ContactCTA() {
  return (
    <div id="contact" className="relative mx-auto mt-32 max-w-7xl px-6 pb-32 sm:mt-56 lg:px-8">
...
function BackgroundGradient() {
  return (
    ...
    >
      ...
      <div
        className="absolute -top-20 -right-20 h-80 w-80 transform-gpu rounded-full bg-primary/10 blur-3xl"
      />
      <div
        className="absolute -bottom-20 -left-20 h-80 w-80 transform-gpu rounded-full bg-secondary/10 blur-3xl"
      />
    </div>
  );
}
