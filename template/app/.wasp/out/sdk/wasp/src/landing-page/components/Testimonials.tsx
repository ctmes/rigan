              ...
              <CardFooter className="flex flex-col pt-0">
                ...
                >
                  {testimonial.avatarSrc ? (
                    ...
                    <div className="ring-border/20 group-hover:ring-primary/30 bg-primary text-primary-foreground flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-semibold ring-2 transition-all duration-200">
                      {testimonial.name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")
